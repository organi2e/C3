...
public class Tanh {
	...
	public static func adapter(W: Float = 1, L1: Float = 0, L2: Float = 0) -> (MTLDevice) throws -> (Int) -> Adapter {
		let bundle: Bundle = Bundle(for: self)
		let kernel: String = String(describing: self)
		let constantValues: MTLFunctionConstantValues = MTLFunctionConstantValues()
		constantValues.setConstantValue([W], type: .float, withName: "W")
		...
		return {
			...
			return {
				Tanh(pipeline: (generate, gradient), count: $0)
			}
		}
	}
}
extension Tanh: Adapter {
